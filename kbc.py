...
padav=["Pehla padav","Dusra padav","Teesra padav",]
...
for index in range(15):
    if flagRightAnswer:
        ...
        if ans == "quit":
            ...
            print "aap yaha se",prize[index],"jeet kar jaa rahe hai"
            ...
            flagRightAnswer=False
            print "aap",prize[index],"jeet kar yaha se jaa rahe hai"
        if ans == answer_key[index]:
            print "aap",prize[index],"jeet chuke hai"

        elif prize[index] == 10000:
            print "Congrats, aapka",padav[index],"pura hua"

        elif prize[index] == 320000:
            print "Congrats,aapka",padav[index],"pura hua"

        elif prize[index] == 10000000:
            print "Congrats,aapka",padav[index],"bhi pura hua"
